...
var argv = require('yargs')
  ...
  .command('build', 'build a zip that can be uploaded to AppHub', function (yargs, argv) {
    ...
    var BUILD_DIR_NAME = argv.platform + BUILD_DIR_SUFFIX;
    ...
    var gradleFile = argv.gradleFile || 'android/build.gradle';
    ...
    cmds.push('cd ' + tmpDir + ' && zip -r ' + outputZip + ' ' + BUILD_DIR_NAME)
